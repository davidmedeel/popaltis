...
if (_param isEqualTo "Init") exitWith {
  ...
  _npc addAction ["<t size='1.5'><t color=""#DE2828"">" + "Empezar Trabajo",{["solicito"] spawn medel_fnc_avionetas;},[],1.5,true,true,"","(playerside isEqualTo civilian)",5,false,"",""];
  _npc addAction ["<t size='1.5'><t color=""#21618C"">" + "Cobrar",{["cobro"] spawn medel_fnc_avionetas;},[],1.0,true,true,"","(playerside isEqualTo civilian)",5,false,"",""];
  _npc addAction ["<t size='1.5'><t color=""#00ff26"">" + "Cancelar Trabajo",{["cancelo"] spawn medel_fnc_avionetas;},[],0.5,true,true,"","(playerside isEqualTo civilian)",5,false,"",""];
  _npc addAction ["<t size='1.5'><t color=""#ad0707"">" + "Debug",{["debug"] spawn medel_fnc_avionetas;},[],0.5,true,true,"","(playerside isEqualTo civilian)",5,false,"",""];
};
...
if (_param isEqualTo "solicito") exitWith {
  ...
  ["generoZona"] spawn medel_fnc_avionetas;
};

if (_param isEqualTo "generoZona") exitWith {

  _zonaGenerada = format ["avioneta_%1", round random 5];

  ["empiezo", _zonaGenerada] spawn medel_fnc_avionetas;
};
...
if (_param isEqualTo "empiezo") exitWith {
  ...
  tecla = (findDisplay 46) displayaddEventHandler ["KeyDown", "if ((_this select 1) isEqualto 37) then {['entrego'] spawn medel_fnc_avionetas;}"];
};
