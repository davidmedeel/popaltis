...
try {
...

	{
		...
		if (isNull _topConfig) then {
			...
			if (isNull _titleDisplay) throw "El display del titulo no funciona";
			...
			_ctrlActionText ctrlSetStructuredText parseText format ["<t size='1' align='left' shadow='2'><t color='#FE6B2E'>+%1 EXP</t> <t color='#FFFFFF'>%2</t></t>", _expAdded, _message ];
			...
			_ctrlInfoText ctrlSetStructuredText parseText format ["<t size='1' align='right' shadow='0' color='#FFFFFF'>%1 EXP</t></t>", _newExp];
