...
class TTM_GUI_RscDisplayTalentOverview {
    ...
    movingEnable = 0;
    enableSimulation = 1;
    scriptPath = "medel\maverick\talent-tree-modular\gui\RscDisplayTalentOverview.sqf";
    ...
    class controls {
		...
		{
			idc = 8;
			text = "Nombre de la Habilidad"; //--- ToDo: Localize;
		...
		{
			idc = 9;
			text = "Descripción de la Habilidad"; //--- ToDo: Localize;
			x = 0.494844 * safezoneW + safezoneX;
		...
		{
			idc = 10;
			text = "DESBLOQUEAR"; //--- ToDo: Localize;
