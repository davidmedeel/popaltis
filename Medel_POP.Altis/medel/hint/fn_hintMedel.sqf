...
por: Medel
Se invoca con
["texto","string",duracion,.tamaño] call medel_fnc_hint;
["<t size = ""1.8"" color=""#DE2828"" align='center'>AVISO <br/>
[<t size = ""1.2"" color=""#FB8C00"" align='left'>texto</t></t>","string",duracion,.tamaño] remoteexec ["medel_fnc_hint",a quien];
[format ["%1",_variable],"string",duracion,.tamaño] call medel_fnc_hint;
[localize "STRINGTABLE","string",duracion,.tamaño] call medel_fnc_hint;
*/
