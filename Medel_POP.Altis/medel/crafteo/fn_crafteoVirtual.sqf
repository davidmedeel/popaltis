/*
	...
	["menu"] call medel_fnc_crafteoVirtual;
...
if (_param isEqualto "craft") exitWith {
	...
	{
	[true,_x select 0,-(_x select 1) * _multiplicador,1] call life_fnc_handleInv;
	} forEach _materiales;
	...
	[true,((_arrayReceta select 2) select 0),((_arrayReceta select 2) select 1) * _multiplicador,1] call life_fnc_handleInv;
