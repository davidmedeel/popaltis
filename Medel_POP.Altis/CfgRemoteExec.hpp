...
class CfgRemoteExec {
    class Functions {
        ...
        #include "medel\maverick\medel_remoteExec_master.cpp"

        /* Funciones solo del cliente */
        F(BIS_fnc_endMission,CLIENT)
        F(bis_fnc_setidentity,CLIENT)
        ...
        F(mav_ttm_fnc_addExp,CLIENT)
        F(life_fnc_kick,CLIENT)
        F(medel_fnc_DNI,CLIENT)
        F(est_fnc_dinero,CLIENT)
        F(est_fnc_amordazar,CLIENT)

        /* Funciones solo del Servidor */
        ...
        F(ica_fnc_ocultame,SERVER)
        F(medel_fnc_customlog,SERVER)

        /* Funciones solo de HeadlessClient */
        ...
        /* Funciones para todos los jugadores */
        ...
        F(life_fnc_luna,ANYONE)
        F(life_fnc_quitarLluvia,ANYONE)
        F(life_fnc_quitarNiebla,ANYONE)
        F(life_fnc_enviaMensaje,ANYONE)
        F(ica_fnc_anuncio,ANYONE)
        F(medel_fnc_gesDinero,ANYONE)
        F(medel_fnc_gesRol,ANYONE)
        F(medel_fnc_hint,ANYONE)
        F(medel_fnc_hintSilent,ANYONE)
        F(medel_fnc_hintMedel,ANYONE)
        F(medel_fnc_hintSilentMedel,ANYONE)
        F(est_fnc_check,ANYONE)
    };
    ...
    class Commands {
        ...
        F(hintSilent,ANYONE)
        F(call,CLIENT)
        F(removeAllWeapons,CLIENT)
        F(serverCommand,SERVER)
    };
};
