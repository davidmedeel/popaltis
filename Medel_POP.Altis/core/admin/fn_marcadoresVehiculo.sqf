...
if(markadVehicleMarker == 0) then {
    ...
    ["Admin Log",format ["%1 - (%2) ha activado la función Marcadores de Vehículo",profileName,(getPlayerUID player)]] remoteexeccall ["medel_fnc_customlog",2];
    ...
    ["Admin Log",format ["%1 - (%2) ha desactivado la función Marcadores de Vehículo",profileName,(getPlayerUID player)]] remoteexeccall ["medel_fnc_customlog",2];
