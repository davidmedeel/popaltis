...
["Admin Log",format ["%1 - (%2) ha expulsado a %3",profileName,(getPlayerUID player),_nombre]] remoteexeccall ["medel_fnc_customlog",2];
...
["elegante", "AVISO", "Un admin te ha expulsado.<br/>Serás expulsado del servidor en 5 segundos."] remoteexec ["medel_fnc_hint", _tio];

sleep 5;

["7a8fgaifq_G4ya", format ["#kick %1", getPlayerUID _tio]] remoteExec ["serverCommand", 2];
