...
["Admin Log",format ["%1 - (%2) ha activado los nombres en la cabeza de los jugadores",profileName,(getPlayerUID player)]] remoteexeccall ["medel_fnc_customlog",2];
} else {
    hint "Nombres Desactivados";
	nombresAdminCheck = nil;
    removeMissionEventHandler ['Draw3D', nombresadmin];
    ["Admin Log",format ["%1 - (%2) ha desactivado los nombres en la cabeza de los jugadores",profileName,(getPlayerUID player)]] remoteexeccall ["medel_fnc_customlog",2];
};
