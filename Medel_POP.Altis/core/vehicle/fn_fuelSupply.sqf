...
_pgText ctrlSetText format ["Depósito:  %1 Ltr / %2 Ltr",_fuelState,_fuelSpace];
...
waitUntil {
    ...
    _progress progressSetPosition _fuelLevel;
    _pgText ctrlSetText format ["Depósito Actual: %1 Litros / %2 Litros  [%3€ / Litros]",_fuelState,_fuelSpace,_price];
