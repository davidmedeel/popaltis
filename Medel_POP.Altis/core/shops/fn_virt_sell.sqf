...
if ([false,_type,_amount] call life_fnc_handleInv) then {
    hint parsetext format ["<br/><t color='#e7ad3e' size='2' shadow='1'shadowColor='#7e521c'>MERCADO<br/></t> <br/><t color='#e7ad3e' size='2'></t> <t color='#FFFFFF' size='1.5'>Has vendido %1 %2 por %3€.", _amount,(localize _name),[_price] call life_fnc_numberText];
    CASH = CASH + _price;
