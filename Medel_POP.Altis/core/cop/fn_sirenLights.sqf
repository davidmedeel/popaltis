...
if !(typeOf _vehicle in ["C_Offroad_01_F","C_Hatchback_01_F","C_SUV_01_F","C_Van_02_medevac_F","C_Hatchback_01_sport_F","B_GEN_Van_02_transport_F","B_GEN_Van_02_vehicle_F","B_MRAP_01_F"]) exitWith {};
