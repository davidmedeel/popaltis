...
private _altisGasolineras = [[["Altis", _altisGasolineras]]] call TON_fnc_terrainSort;

{
    private _gasolinera = nearestObjects [_x,["Land_fs_feed_F","Land_FuelStation_01_pump_F","Land_FuelStation_02_pump_F"],5] select 0;
    _gasolinera setFuelCargo 0;
    _gasolinera addAction ["<t size='1.5'><t color='#21618C'>Repostar</t>",'null =  ["menu"] call ica_fnc_gasolinera;', "", 9,false,true,"","_this distance _target < 5 && cursorObject isEqualTo _target"];
    false
} count _altisGasolineras;
