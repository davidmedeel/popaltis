...
class multas {
	idd = -1;
	movingEnable = 0;
	onLoad = "uiNamespace setVariable ['multas', _this select 0]; abierto = true;";
	onUnLoad = "uiNamespace setVariable ['multas', nil]; abierto = nil";
...
{
	idc = 5056;
	onLBSelChanged = "['actualiza'] call medel_fnc_multas;";
