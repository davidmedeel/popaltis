...
{
	idc = 1001;
	text = "Menu de Admin"; //--- ToDo: Localize;
	x = 0.298906 * safezoneW + safezoneX;
...
{
	idc = 2905;
	onButtonClick = "[] call life_fnc_adminLlaves;";
...
class hojas: RscButton
{
	idc = 2908;
	onButtonClick = "[] call life_fnc_adminParticulas";
	text = "Hojas"; //--- ToDo: Localize;
...
{
	idc = 2911;
	onButtonClick = "[call compile format ['%1', (lbData [2902, lbCurSel (2902)])]] spawn life_fnc_adminCrasheo;";
...
{
	idc = 2908;
	onButtonClick = "[] spawn life_fnc_adminMarcadores;";
...
{
	idc = 2908;
	onButtonClick = "[] spawn life_fnc_nombres;";
...
{
	idc = 2908;
	onButtonClick = "[call compile format ['%1', (lbData [2902, lbCurSel (2902)])]] spawn life_fnc_adminCongelar;";
...
{
	idc = 2908;
	onButtonClick = "[call compile format ['%1', (lbData [2902, lbCurSel (2902)])]] spawn life_fnc_voyati;";
...
{
	idc = 2911;
	onButtonClick = "[] call life_fnc_invisible;";
...
{
	idc = 2911;
	onButtonClick = "[call compile format ['%1', (lbData [2902, lbCurSel (2902)])]] spawn life_fnc_adminRevivir;";
...
{
	idc = 2908;
	onButtonClick = "[call compile format ['%1', (lbData [2902, lbCurSel (2902)])]] spawn life_fnc_venami;";
...
{
	idc = 2908;
	onButtonClick = "[call compile format ['%1', (lbData [2902, lbCurSel (2902)])]] spawn life_fnc_adminCurar;";
...
{
	idc = 2908;
	onButtonClick = "[call compile format ['%1', (lbData [2902, lbCurSel (2902)])]] spawn life_fnc_adminEspectador;";
...
{
	idc = 2908;
	onButtonClick = "[] spawn life_fnc_adminBorrar;";
...
{
	idc = 2911;
	onButtonClick = "[] call life_fnc_mensaje;";
...
{
	idc = 2908;
	onButtonClick = "[] spawn medel_fnc_gasolina;";
...
{
	idc = 2908;
	onButtonClick = "[call compile format ['%1', (lbData [2902, lbCurSel (2902)])]] spawn life_fnc_killAdmin;";
...
{
	idc = 2908;
	onButtonClick = "[] spawn life_fnc_marcadoresVehiculo;";
...
class skiptime12h: RscButton
{
	idc = 2908;
	onButtonClick = "[] call life_fnc_dedia;";
	text = "Avanzar 12h"; //--- ToDo: Localize;
	x = 0.443281 * safezoneW + safezoneX;
	y = 0.687 * safezoneH + safezoneY;
	w = 0.061875 * safezoneW;
	h = 0.022 * safezoneH;
...
class withelist: RscButton
{
	idc = 2908;
	onButtonClick = "[] spawn medel_fnc_daWithelist;";
	text = "Withelist"; //--- ToDo: Localize;
	x = 0.510312 * safezoneW + safezoneX;
	y = 0.401 * safezoneH + safezoneY;
	w = 0.134062 * safezoneW;
	h = 0.022 * safezoneH;
};
class vetarPoli: RscButton
{
	idc = 2908;
	onButtonClick = "[] spawn life_fnc_vetarPoli;";
	text = "Vetar Policía"; //--- ToDo: Localize;
...
{
	idc = 2908;
	onButtonClick = "[call compile format ['%1', (lbData [2902, lbCurSel (2902)])]] spawn life_fnc_equipo;";
...
{
	idc = 2908;
	onButtonClick = "[call compile format ['%1', (lbData [2902, lbCurSel (2902)])]] spawn life_fnc_forzarDesconexionAdmin;";
...
{
	idc = 2908;
	onButtonClick = "[call compile format ['%1', (lbData [2902, lbCurSel (2902)])]] spawn life_fnc_kickAdmin;";
...
{
	idc = 2908;
	onButtonClick = "[call compile format ['%1', (lbData [2902, lbCurSel (2902)])]] spawn life_fnc_explotar;";
...
{
	idc = 2908;
	onButtonClick = "[call compile format ['%1', (lbData [2902, lbCurSel (2902)])]] spawn life_fnc_sacarDelVehiculo;";
...
{
	idc = 2908;
	onButtonClick = "[call compile format ['%1', (lbData [2902, lbCurSel (2902)])]] spawn life_fnc_voyatuVeh;";
...
{
	idc = 2908;
	onButtonClick = "[call compile format ['%1', (lbData [2902, lbCurSel (2902)])]] spawn life_fnc_moverEnMiVeh;";
...
class darDinero: RscButton
{
	idc = 2908;
	onButtonClick = "[] spawn medel_fnc_darDineroAdmin;";
	text = "Dar Dinero"; //--- ToDo: Localize;
	x = 0.510312 * safezoneW + safezoneX;
	y = 0.533 * safezoneH + safezoneY;
	w = 0.134062 * safezoneW;
	h = 0.022 * safezoneH;
};
class quitarDinero: RscButton
{
	idc = 2908;
	onButtonClick = "[] spawn medel_fnc_quitarDineroAdmin;";
...
{
	idc = 2908;
	onButtonClick = "[] spawn life_fnc_reiniciarRobosCurso;";
...
{
	idc = 2908;
	onButtonClick = "[] spawn life_fnc_reiniciarRobos;";
	text = "Reiniciar Robos"; //--- ToDo: Localize;
	x = 0.649531 * safezoneW + safezoneX;
	y = 0.566 * safezoneH + safezoneY;
	w = 0.134062 * safezoneW;
	h = 0.022 * safezoneH;
...
{
	idc = 2911;
	onButtonClick = "[] remoteexec ['life_fnc_luna', 0];";
...
{
	idc = 2911;
	onButtonClick = "[call compile format ['%1', (lbData [2902, lbCurSel (2902)])]] spawn life_fnc_esposarJugador;";
...
{
	idc = 2911;
	onButtonClick = "[call compile format ['%1', (lbData [2902, lbCurSel (2902)])]] spawn life_fnc_desesposarJugador;";
...
{
	idc = 5908;
	onButtonClick = "[] spawn life_fnc_entrarServicio;";
...
{
	idc = 2911;
	onButtonClick = "[] remoteexec ['life_fnc_quitarNiebla', 0];";
...
{
	idc = 2911;
	onButtonClick = "[] remoteexec ['life_fnc_quitarLluvia', 0];";
...
{
	idc = 2908;
	onButtonClick = "[call compile format ['%1', (lbData [2902, lbCurSel (2902)])]] spawn life_fnc_copiarEquipacion;";
...
{
	idc = 2908;
	onButtonClick = "[call compile format ['%1', (lbData [2902, lbCurSel (2902)])]] spawn life_fnc_ponEquipacion;";
