...
if (_param isEqualTo "Init") exitWith {
    ...
    _npc addAction
    [
        "<t size='1.5'><t color=""#DE2828"">" + "Robar el Laboratorio",
        {
            ["Robo"] spawn est_fnc_roblaboratorio;
        },
        [],
        1.5,
        true,
    ...
    _caja addAction ["<t size='1.5'><t color=""#DE2828"">" + "Abrir Cofre",{_this call des_fnc_abroInventario},[],1.5,true,true,"","(playerside isEqualTo civilian)",5,false,"",""];
...
if (_param isEqualTo "Robo") exitWith {
    ...
    [10,"Alarma - Robo",[1,0,0,1],2,("!Están robando el Laboratorio!"),[1,1,1,1],1.5] remoteexec ["ica_fnc_anuncio",west];

    _Pos = position player;
    _MarkerN = format ["%1_Marker",[_npc] call BIS_fnc_objectVar];
    _MarkerT = "!ATENCION, Están Robando el Laboratorio";
    ...
    hintSilent parseText format ["<t size = ""2"" color=""#DE2828"" align='center' >Robo al Laboratorio<br/>
    ...
    _din = (180000 + (1000 * _polisOn));
    medel_din = _din + medel_din;
    "RoboMediano" remoteexec ["mav_ttm_fnc_addExp", group player];
    hint format ["En el Robo a el Laboratorio se ha obtenido %1€ ",_din];
};
