...
if (_param isEqualTo "Init") exitWith {
    ...
    _npc addAction
    [
        "<t size='1.5'><t color=""#DE2828"">" + "Robar el Almacen",
        {
            ["Robo"] spawn est_fnc_robalmacen;
        },
        [],
        1.5,
        true,
...
if (_param isEqualTo "Robo") exitWith {
    ...
    [10,"Alarma - Robo",[1,0,0,1],2,("!Están robando el Almacen!"),[1,1,1,1],1.5] remoteexec ["ica_fnc_anuncio",west];

    _Pos = position player;
    _MarkerN = format ["%1_Marker",[_npc] call BIS_fnc_objectVar];
    _MarkerT = "!ATENCION, Están Robando el Almacen";
    ...
    hintSilent parseText format ["<t size = ""2"" color=""#DE2828"" align='center' >Robo al Almacen<br/>
    ...
    hint format ["En el Robo a el Almacen se ha obtenido %1€ ",_din];
};
