...
if (_param isEqualTo "Init") exitWith {
    ...
    _npc addAction
    [
        "<t size='1.5'><t color=""#DE2828"">" + "Robar el Casino",
        {
            ["Robo"] spawn est_fnc_robcasino;
        },
        [],
        1.5,
        true,
...
if (_param isEqualTo "Robo") exitWith {
    ...
    if ((count units (group player)) < 8) exitWith {hint "No tienes suficientes miembros en tu banda ahora mismo como para robar casino "};
    ...
    hintSilent parseText format ["<t size = ""2"" color=""#DE2828"" align='center' >Robo a Casino<br/>
    ...
    _din = (1500000 + (1000 * _polisOn));
    medel_din = _din + medel_din;
    "RoboGrande" remoteexec ["mav_ttm_fnc_addExp", group player];
    hint format ["En el Robo a el Casino se ha obtenido %1€ ",_din];
};
