...
if (_param isEqualTo "Init") exitWith {
    ...
    _npc addAction
    [
        "<t size='1.5'><t color=""#DE2828"">" + "Robar Repsol",
        {
            ["Robo"] spawn est_fnc_robrepsol;
        },
        [],
        1.5,
        true,
...
if (_param isEqualTo "Robo") exitWith {
    ...
    [10,"Alarma Silenciosa",[1,0,0,1],2,("!Están robando Repsol!"),[1,1,1,1],1.5] remoteexec ["ica_fnc_anuncio",west];

    _Pos = position player;
    _MarkerN = format ["%1_Marker",[_npc] call BIS_fnc_objectVar];
    _MarkerT = "!ATENCIÓN! Están Robando Repsol";
    ...
    hintSilent parsetext format ["<t size = ""2"" color=""#DE2828"" align='center' >Robo a Repsol<br/>
    ...
    hint format ["En el Robo a Repsol se ha obtenido %1€ ",_din];
};
