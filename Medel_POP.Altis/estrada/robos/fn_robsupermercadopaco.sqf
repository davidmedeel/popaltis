...
_npc = SupermercadoPaco;
if (_param isEqualTo "Init") exitWith {

    _npc addAction
    [
        "<t size='1.5'><t color=""#DE2828"">" + "Robar el Supermercado de Paco",
        {
            ["Robo"] spawn est_fnc_robsupermercadopaco;
        },
        [],
        1.5,
        true,
...
if (_param isEqualTo "Robo") exitWith {
    ...
    [10,"Alarma - Robo",[1,0,0,1],2,("!Están robando el Supermercado de Paco!"),[1,1,1,1],1.5] remoteexec ["ica_fnc_anuncio",west];

    _Pos = position player;
    _MarkerN = format ["%1_Marker",[_npc] call BIS_fnc_objectVar];
    _MarkerT = "!ATENCIÓN! Están Robando el Supermercado de Paco";
    ...
    hintSilent parseText format ["<t size = ""2"" color=""#DE2828"" align='center' >Robo a el Supermercado de Paco<br/>
    ...
    hint format ["En el Robo a el Supermercado de Paco se ha obtenido %1€ ",_din];
};
