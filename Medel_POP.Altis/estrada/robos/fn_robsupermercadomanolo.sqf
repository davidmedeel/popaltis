...
_npc = SupermercadoManolo;
if (_param isEqualTo "Init") exitWith {
    
    _npc addAction
    [
        "<t size='1.5'><t color=""#DE2828"">" + "Robar el Supermercado de Manolo",
        {
            ["Robo"] spawn est_fnc_robsupermercadomanolo;
        },
        [],
        1.5,
        true,
...
if (_param isEqualTo "Robo") exitWith {
    ...
    [10,"Alarma - Robo",[1,0,0,1],2,("!Están robando el Supermercado de Manolo!"),[1,1,1,1],1.5] remoteexec ["ica_fnc_anuncio",west];

    _Pos = position player;
    _MarkerN = format ["%1_Marker",[_npc] call BIS_fnc_objectVar];
    _MarkerT = "!ATENCIÓN! Están Robando el Supermercado de Manolo";
    ...
    hintSilent parseText format ["<t size = ""2"" color=""#DE2828"" align='center' >Robo a el Supermercado de Manolo<br/>
    ...
    _din = (50000 + (1000 * _polisOn));
    medel_din = _din + medel_din;
    "RoboMediano" remoteexec ["mav_ttm_fnc_addExp", group player];
    hint format ["En el Robo a el Supermercado de Manolo se ha obtenido %1€ ",_din];
};
