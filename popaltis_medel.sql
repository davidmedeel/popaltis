...
--
-- Creates database `popaltis_medel` unless it already exists and uses `popaltis_medel`
-- Default Schema
--
CREATE DATABASE IF NOT EXISTS `popaltis_medel` DEFAULT CHARACTER SET utf8mb4;
USE `popaltis_medel`;
...
GRANT SELECT, UPDATE, INSERT, EXECUTE ON `popaltis_medel`.* TO 'arma3'@'localhost';
FLUSH PRIVILEGES;
